...
public class Pregunta {
 private int id;
    ...
    public Pregunta() {
       ...
       public Pregunta(String title, String description, String imagePath, Categoria category) {
   ...
   public Pregunta(int id, String title, String description, String imagePath, Categoria category){
